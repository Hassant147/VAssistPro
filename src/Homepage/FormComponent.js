...
const FormComponent = ({darkMode}) => {
    ...
    return (
        <section className="py-14 sm:py-16 lg:py-20 bg-white dark:bg-[#151515] dark:text-white border-b">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start mx-auto">
                    ...
                    <div className="md:w-[30%] w-full bg-gray-100 dark:bg-black rounded-lg shadow-lg p-4 lg:p-7 text-start md:mt-0 mt-8">
                        ...
                        <ul className="space-y-2">
                            <li className="flex items-center dark:border-b-[#17AEE7] border-b-[#6155A8] border-b-[0.5px] pb-2 text-sm md:text-sm xl:text-base text-black dark:text-gray-300">
                                <img
                                    className="w-3 h-3 mr-2"
                                    src={darkMode ? DarkTick : lightTick} // Use the dark mode state to set the tick
                                    alt="Tick Icon"
                                />
